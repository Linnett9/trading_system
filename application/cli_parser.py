...
def parse_args():
    ...
    parser.add_argument("--plan-job-identity", default=None)
    parser.add_argument("--component-runner", default=None)
    parser.add_argument("--operational-input-package", default=None)
