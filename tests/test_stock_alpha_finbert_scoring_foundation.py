...
def _request(tmp_path: Path, package):
    payload = {
        ...
        "model_configuration_sha256": package["model_configuration_sha256"],
        "tokenizer_configuration_sha256":
            package["tokenizer_configuration_sha256"],
        "vocabulary_sha256": package["vocabulary_sha256"],
        "inference_contract": "stock_alpha_finbert_article_inference.v1",
        "text_selection_contract": "stock_alpha_finbert_text_selection.v1",
        "scored_at_utc": "2026-07-19T21:33:52Z",
