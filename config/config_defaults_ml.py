ML_DEFAULTS = {
    ...
    "stock_fundamentals": {
        ...
        "coverage": {
            ...
            "snapshot_coverage_action": "warn",
            "feature_family_action": "warn",
            "minimum_entity_mapping_coverage": None,
            "minimum_snapshot_coverage": None,
            "minimum_feature_family_non_null_fraction": None,
            "minimum_symbols_per_decision_date": None,
            "minimum_decision_date_coverage": None,
        },
        "bounded": {
            "maximum_entities": None,
            "maximum_decision_dates": None,
    ...
    "selector_universe_integrity_audit": {
        ...
        "universe_path": None,
        "price_manifest_path": "data/reference/adjusted_prices/manifest.json",
        "classification_mapping_path": "data/reference/sector_by_symbol.json",
        "output_dir": None,
        "allow_csv_fallback": False,
        "maximum_decision_dates": None,
        "maximum_symbols": None,
